...
export default function Careers({ careerPosts }: any) {
            ...
            {types.map((item, index) => (
              ...
              >
                <Button
                  ...
                  className={
                    type === item
                      ? "w-full h-[50px] py-1 rounded-[21px] border-[6px] border-solid border-[#0E0E0E] bg-secondary flex justify-center items-center cursor-pointer text-center text-white text-[14.4px]/[25.84px] font-normal font-primary normal-case hover:bg-secondary hover:border-[#0E0E0E] p-2"
                      : "w-full h-[50px] py-1 rounded-[21px] border-[6px] border-solid border-white bg-transparent flex justify-center items-center cursor-pointer text-center text-white text-[14.4px]/[25.84px] font-normal font-primary normal-case hover:bg-secondary hover:border-[#0E0E0E] p-2"
                  }
                >
                  {item}
                </Button>
