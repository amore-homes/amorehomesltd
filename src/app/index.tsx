      ...
      <div className="w-full overflow-hidden" ref={ref}>
        ...
        <Box component="main" className="w-full grow relative min-h-screen">
          ...
          <Link
            ...
            target="_blank"
            className="bg-[#4dbc4b] hover:bg-[#4FBB4D] fixed bottom-14 right-4 w-[220px] h-[48px] z-[2000000] rounded-full shadow-xl cursor-pointer hover:scale-[1.005] flex items-center justify-center font-primary font-bold text-white px-4 py-6 gap-2"
          >
